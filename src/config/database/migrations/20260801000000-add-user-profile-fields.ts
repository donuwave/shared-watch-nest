...
export class AddUserProfileFields20260801000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "discriminator" character varying(4)`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_users_username_discriminator" ON "users" ("username", "discriminator")`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_users_username_discriminator"`,
    );
